...
let theater = {
    ...
    showMovieList(){
        ...
        this.titles.forEach(
            title => console.log(this.store + ":" + title)  // 반드시 화살표 함수를 써야하는 경우도 있다.
            );
...
/* 생성자 함수로 사용하지 않는 일반 함수는 화살표 함수로 만든다.(객체 생성 X) */
const arrowFunc = () => {};
...
// new arrowFunc();           // 에러 발생(화살표 함수이기 때문에)
new nomalFunc();
...
/* 
    ...
    위와 같은 특징들은 콜백함수 내부의 this가 외부 함수의 this와 다르기 때문에 발생하는 문제를 해결하기 위해
